...
public:
	...
	inline const vec2& getOldPosition()const { return m_BasicModel.oldPosition; }
	...
	inline float getSimTimeRemaining()const { return m_BasicModel.simTimeRemaining; }
	...
	inline vec2& changeOldPosition() { return m_BasicModel.oldPosition; }
	...
	inline float& changeSimTimeRemaining() { return m_BasicModel.simTimeRemaining; }

	virtual vec2 getSize()const = 0;
	virtual bool collisionDeetection(Sprite2D* target) = 0;
	virtual void staticCollision(Sprite2D* target) = 0;
	virtual void dynamicCollision(Sprite2D* target) = 0;
